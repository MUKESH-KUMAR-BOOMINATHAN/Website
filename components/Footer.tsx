...
const Footer: React.FC = () => {
  return (
    ...
    >
      <Grid container spacing={3} justifyContent="center" alignItems="flex-start">
        ...
        <Grid item xs={12} md={4} sx={{ borderRight: { md: '1px solid #374151' }, pr: { md: 4 } }}>
          <Box display="flex" alignItems="center" mb={1}>
            ...
            <Typography variant="subtitle1" fontWeight="bold"> {/* Changed to subtitle1 */}
        ...
        <Grid item xs={12} md={4} sx={{ borderRight: { md: '1px solid #374151' }, px: { md: 4 } }}>
          <Typography variant="subtitle1" gutterBottom fontWeight="bold"> {/* Changed to subtitle1 */}
            Connect With Us
          </Typography>
          <Box display="flex" alignItems="center" mb={1}>
      ...
      <Divider sx={{ my: 2, borderColor: '#374151' }} /> {/* Reduced margin */}
